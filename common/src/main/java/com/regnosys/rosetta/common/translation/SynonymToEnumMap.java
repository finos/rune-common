 ...
 *
 * @deprecated Enum synonyms have been removed from the Rune DSL, so this map is no longer populated
 * from generated code. Retained only for backwards compatibility and will be removed in a future release.
 */
@Deprecated
