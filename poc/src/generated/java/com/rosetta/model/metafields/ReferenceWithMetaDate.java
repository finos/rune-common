...
public interface ReferenceWithMetaDate extends RosettaModelObject, ReferenceWithMeta<Date> {
	...
	ReferenceWithMetaDateBuilder toBuilder();
	
	static ReferenceWithMetaDateBuilder builder() {
	...
	/*********************** Builder Interface  ***********************/
	interface ReferenceWithMetaDateBuilder extends ReferenceWithMetaDate, RosettaModelObjectBuilder, ReferenceWithMetaBuilder<Date> {
		Reference.ReferenceBuilder getOrCreateReference();
		Reference.ReferenceBuilder getReference();
		ReferenceWithMetaDateBuilder setValue(Date value);
		ReferenceWithMetaDateBuilder setGlobalReference(String globalReference);
		ReferenceWithMetaDateBuilder setExternalReference(String externalReference);
		ReferenceWithMetaDateBuilder setReference(Reference reference);
		...
		ReferenceWithMetaDateBuilder prune();
	}
	...
	class ReferenceWithMetaDateImpl implements ReferenceWithMetaDate {
		...
		public ReferenceWithMetaDateBuilder toBuilder() {
			ReferenceWithMetaDateBuilder builder = builder();
	...
	class ReferenceWithMetaDateBuilderImpl implements ReferenceWithMetaDateBuilder {
		...
		@Override
		@RosettaAttribute("value")
		public ReferenceWithMetaDateBuilder setValue(Date value) {
		...
		@Override
		@RosettaAttribute("address")
		public ReferenceWithMetaDateBuilder setReference(Reference reference) {
