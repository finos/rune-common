...
public interface NodeRef extends RosettaModelObject {
	...
	interface NodeRefBuilder extends NodeRef, RosettaModelObjectBuilder {
		...
		NodeRefBuilder setAReference(ReferenceWithMetaA aReference0);
		NodeRefBuilder setAReferenceValue(A aReference1);
	...
	class NodeRefBuilderImpl implements NodeRefBuilder {
		...
		@Override
		@RosettaAttribute("typeA")
		public NodeRefBuilder setTypeA(A typeA) {
			this.typeA = typeA==null?null:typeA.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("aReference")
		public NodeRefBuilder setAReference(ReferenceWithMetaA aReference) {
			this.aReference = aReference==null?null:aReference.toBuilder();
			return this;
		}
		@Override
		public NodeRefBuilder setAReferenceValue(A aReference) {
			this.getOrCreateAReference().setValue(aReference);
			return this;
		}
