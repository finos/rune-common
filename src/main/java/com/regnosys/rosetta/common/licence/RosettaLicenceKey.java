...
public class RosettaLicenceKey {
	...
	public static void main(String[] args) throws IOException {
		if (args.length != 5) {
			...
			System.out.println(
					"Example: java com.regnosys.rosetta.licence.RosettaLicenceKey scripts/rosetta-licences/rosetta-licence-private-key.der 'the client name' RosettaIngest 1.0.0 2018-12-31");
			System.exit(1);
		}
