...
public class JsonProjectionDataLoader extends AbstractJsonDataLoader<ProjectionDataSet> {
    ...
    public ProjectionDataSet loadInputFiles(ProjectionDataSet descriptor) {
        ...
        return new ProjectionDataSet(descriptor.getDataSetName(), descriptor.getDataSetShortName(), descriptor.getInputType(), descriptor.getApplicableProjection(), loadedData, descriptor.getApplicableProjectionsSet());
    }
}