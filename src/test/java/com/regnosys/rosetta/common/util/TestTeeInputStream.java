...
class TestTeeInputStream {
	...
	void test() throws IOException, InterruptedException, ExecutionException {
		...
		TeeInputStream tin = new TeeInputStream(bin);
		TeedInputStream[] splitInto = tin.splitInto(2);
		BufferedReader reader1 = new BufferedReader(new InputStreamReader(splitInto[0]));
		BufferedReader reader2 = new BufferedReader(new InputStreamReader(splitInto[1]));
